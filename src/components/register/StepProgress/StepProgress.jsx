    ...
    <>
      <section className={styles.progressContainer}>
        ...
        <span className={styles.progressGroup} data-phase="address">
          <span className={styles.iconContainerDone}>
            <span className={styles.textDone}>1</span>
            <PgComplete className={styles.icon} style={{display: 'none'}}/>
          </span>
        ...
        <span className={styles.progressGroup} data-phase="shipping">
          <span className={styles.iconContainerUndone}>
            <span className={styles.textUndone}>2</span>
            <PgComplete className={styles.iconUndone} style={{ display: 'none' }} />
          </span>
